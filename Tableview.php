...
$title="User Feedback View for :&nbsp;<b><font color=\"blue\">[&nbsp;".$_SESSION["name"]."&nbsp;]</font></b>";
...
print "<div class=\"container\">
              <div class=\"scroll-table\">
               ...
               <tbody>
                   ...
                   <tr>
                       <td class=\"product\">Product 1</td>
                       <td class=\"feedback\">
                            <div class=\"long-text\">Feedback 2
                               <p class=\"read-more\"><a href=\"#\" class=\"button\">Read more</a></p>
                            </div></td>
                       <td>User 2</td>
                       <td class=\"rating\"><div class=\"vote\">
                               <button class=\"upvote\" onclick=\"vote('up', this.parentElement)\">+1</button>
                               <p id=\"unique-rating1\" class=\"rating-value\">0</p>
                               <button class=\"downvote\" onclick=\"vote('down', this.parentElement)\">-1</button>
                           </div> </td>
        ...
        <?php
                    ...
                    $result = $conn->query("select  *  from customer join feedbacks on email =`user`");
